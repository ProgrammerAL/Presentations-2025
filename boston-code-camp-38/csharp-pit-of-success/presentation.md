...
# Recommendation: 
## Find a good starter kit

- Example: .NET Library Starter Kit
  - https://github.com/dennisdoomen/dotnet-library-starter-kit/tree/main
  - Very large base repo with a lot of settings
  - Use what you want, remove everything else
